...
public class Discogs {
    ...
    public static void getJSON(Connection conn, String req){
        ...
        try {
            ...
            for (int i = 0; i < values.length(); i++) {
                ...
                if(master.toString() == "null"){
                    ...
                    Record record = addPricesToRecord(getHtmlFromUrl(startUrlItem+uri));
                    ...
                    if(record != null && have<want && want>40){
                        ...
                        try {
                            ...
                            state.executeUpdate("INSERT INTO records (title, artist, album, lowerprice, medianprice, higherprice, have, want) VALUES ('"+ title +"','"+ artist +"', '"+ album +"','"+ record.getLowerPrice() +"','"+ record.getMedianPrice() +"','"+ record.getHigherPrice() +"','"+ have +"','"+ want +"')");
